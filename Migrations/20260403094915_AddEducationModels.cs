...
{
    /// <inheritdoc />
    public partial class AddEducationModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AddColumn<DateTime>(
                name: "PremiumAssignedAt",
                table: "Users",
                type: "datetime2",
                nullable: true);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewText = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
